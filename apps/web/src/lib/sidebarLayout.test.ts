...
import { SIDEBAR_COMPACT_WIDTH, SIDEBAR_MAX_WIDTH, SIDEBAR_MIN_WIDTH, SIDEBAR_NARROW_WIDTH, clampSidebarWidth, sidebarDensityFor } from "./sidebarLayout";
...
describe("sidebar layout", () => {
  it("clamps draggable widths to the desktop range", () => {
    ...
    expect(SIDEBAR_MIN_WIDTH).toBeLessThanOrEqual(SIDEBAR_NARROW_WIDTH);
  });

  it("reports progressive labels while keeping the rail manual", () => {
    ...
    expect(sidebarDensityFor(SIDEBAR_MIN_WIDTH, false)).toBe("narrow");
