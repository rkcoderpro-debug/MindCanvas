...
export const en = {
  ...
  workspace: "Workspace", recent: "Recent files", folders: "Folders", manageFolders: "Manage folders", newFolder: "New folder", folderActions: "Folder actions", renameFolder: "Rename folder", deleteFolder: "Delete folder", deleteFolderHint: "Projects in this folder will be moved back to Workspace. The folder itself will be deleted.", copy: "Copy", paste: "Paste", fileActions: "File actions", emptyFolder: "This folder is empty", deleteFileHint: "Move this project to Trash?", theme: "Appearance", themeChoose: "Choose a color theme", themeLightCollection: "Light themes", themeDarkCollection: "Dark themes", themeLight: "Aurora Light", themeLightHint: "Clean ivory surfaces with vivid violet accents.", themeOcean: "Ocean Breeze", themeOceanHint: "Airy ice blue with ocean and cyan accents.", themeMint: "Mint Frost", themeMintHint: "Fresh mint surfaces with crisp teal contrast.", themeSunset: "Sunset Coral", themeSunsetHint: "Warm cream, coral and tangerine energy.", themeBerry: "Berry Pop", themeBerryHint: "Soft rose surfaces with vibrant raspberry color.", themeDark: "Midnight Dark", themeDarkHint: "Deep plum surfaces with bright lilac contrast.", themeCobalt: "Cobalt Night", themeCobaltHint: "Deep navy with electric blue highlights.", themeCyber: "Cyber Teal", themeCyberHint: "Dark cyan surfaces with luminous aqua accents.", themeForest: "Emerald Forest", themeForestHint: "Deep green surfaces with fresh mint accents.", themeSlate: "Nordic Slate", themeSlateHint: "Cool graphite with calm periwinkle contrast.",
...
export const vi: Record<MessageKey, string> = {
  ...
  workspace: "Workspace", recent: "File gần đây", folders: "Thư mục", manageFolders: "Quản lý thư mục", newFolder: "Thư mục mới", folderActions: "Thao tác thư mục", renameFolder: "Đổi tên thư mục", deleteFolder: "Xóa thư mục", deleteFolderHint: "Các project trong thư mục sẽ được chuyển về Workspace. Chỉ thư mục bị xóa.", copy: "Sao chép", paste: "Dán", fileActions: "Thao tác file", emptyFolder: "Thư mục này đang trống", deleteFileHint: "Đưa project này vào thùng rác?", theme: "Giao diện", themeChoose: "Chọn bảng màu", themeLightCollection: "Theme sáng", themeDarkCollection: "Theme tối", themeLight: "Sáng Aurora", themeLightHint: "Nền trắng ngà với điểm nhấn tím rực rỡ.", themeOcean: "Gió biển Ocean", themeOceanHint: "Xanh băng thoáng nhẹ với điểm nhấn biển và cyan.", themeMint: "Sương bạc hà", themeMintHint: "Nền bạc hà tươi với sắc teal tương phản rõ.", themeSunset: "Hoàng hôn Coral", themeSunsetHint: "Kem ấm, san hô và cam quýt giàu năng lượng.", themeBerry: "Berry Pop", themeBerryHint: "Nền hồng dịu với sắc mâm xôi nổi bật.", themeDark: "Tối Midnight", themeDarkHint: "Nền mận đậm với sắc tím sáng tương phản.", themeCobalt: "Đêm Cobalt", themeCobaltHint: "Xanh navy sâu với điểm nhấn xanh điện.", themeCyber: "Cyber Teal", themeCyberHint: "Nền cyan tối với điểm nhấn aqua phát sáng.", themeForest: "Rừng Emerald", themeForestHint: "Nền xanh rừng đậm với điểm nhấn bạc hà.", themeSlate: "Đá Nordic", themeSlateHint: "Graphite lạnh với sắc xanh tím dịu, rõ nét.",
