...
export const en = {
  ...
  workspace: "Workspace", recent: "Recent files", folders: "Folders", newFolder: "New folder", folderActions: "Folder actions", renameFolder: "Rename folder", deleteFolder: "Delete folder", deleteFolderHint: "Projects in this folder will be moved back to Workspace. The folder itself will be deleted.", theme: "Appearance", themeLight: "Light", themeDark: "Dark",
...
export const vi: Record<MessageKey, string> = {
  ...
  workspace: "Workspace", recent: "File gần đây", folders: "Thư mục", newFolder: "Thư mục mới", folderActions: "Thao tác thư mục", renameFolder: "Đổi tên thư mục", deleteFolder: "Xóa thư mục", deleteFolderHint: "Các project trong thư mục sẽ được chuyển về Workspace. Chỉ thư mục bị xóa.", theme: "Giao diện", themeLight: "Sáng", themeDark: "Tối",
