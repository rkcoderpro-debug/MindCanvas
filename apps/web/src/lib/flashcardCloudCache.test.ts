...
import { fetchFlashcardDecks, fetchFlashcards, readFlashcardDecks, readFlashcards, upsertFlashcardDeck, upsertFlashcards } from "./projectStore";

const { remoteDeck, remoteCard } = vi.hoisted(() => ({
  remoteDeck: {
    id: "cloud-deck",
    name: "Cloud deck",
    project_id: null,
