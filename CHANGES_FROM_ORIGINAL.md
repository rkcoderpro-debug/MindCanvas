...
- Added progressive sidebar density states: folder space fills the available middle region, folder names remain on one line while narrow, and the version badge/name hide progressively without automatically opening the icon rail.
